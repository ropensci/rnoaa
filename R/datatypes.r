...
#' @examples \dontrun{
#' datatypes(dataset="ANNUAL")
#' }
#' @export
datatypes <- function(dataset=NULL, startdate=NULL, enddate=NULL, page=NULL, token=getOption("noaakey", stop("you need an API key NOAA data")))
{
