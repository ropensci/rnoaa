...
#' ncdc2(datasetid='GHCND', stationid='GHCND:USW00014895',
...
#' ncdc2(datasetid='GHCND', locationid = 'FIPS:02', startdate = '2010-05-01',
#'    enddate = '2010-05-10')
#'
#' # GHCND data from October 1 2013 to December 1 2013
#' ncdc2(datasetid='GHCND', startdate = '2013-10-01', enddate = '2013-10-05')
#'
#' # GHCN-Monthly (or GSOM) data from October 1 2013 to December 1 2013
#' ncdc2(datasetid='GSOM', startdate = '2013-10-01', enddate = '2013-12-01')
#' ncdc2(datasetid='GSOM', startdate = '2013-10-01', enddate = '2013-12-01',
#'    stationid = "GHCND:AE000041196")
#'
#' # Normals Daily (or NORMAL_DLY) GHCND:USW00014895 dly-tmax-normal data
#' ncdc2(datasetid='NORMAL_DLY', stationid='GHCND:USW00014895',
#'    startdate = '2010-05-01', enddate = '2010-05-10')
#'
#' # Dataset, and location in Australia
#' ncdc2(datasetid='GHCND', locationid='FIPS:AS', startdate = '2010-05-01',
#'     enddate = '2010-05-31')
#'
#' # Dataset, location and datatype for PRECIP_HLY data
#' ncdc2(datasetid='PRECIP_HLY', locationid='ZIP:28801', datatypeid='HPCP',
#'    startdate = '2010-05-01', enddate = '2010-05-10')
#'
#' # multiple datatypeid's
#' ncdc2(datasetid='PRECIP_HLY', datatypeid = 'HPCP',
#'    startdate = '2010-05-01', enddate = '2010-05-10')
#'
#' # multiple locationid's
#' ncdc2(datasetid='PRECIP_HLY', locationid=c("FIPS:30103", "FIPS:30091"),
#'    startdate = '2010-05-01', enddate = '2010-05-10')
#'
#' # Dataset, location, station and datatype
#' ncdc2(datasetid='PRECIP_HLY', locationid='ZIP:28801',
#'    stationid='COOP:310301', datatypeid='HPCP',
#'    startdate = '2010-05-01', enddate = '2010-05-10')
#'
#' # Dataset, location, and datatype for GHCND
#' ncdc2(datasetid='GHCND', locationid='FIPS:BR', datatypeid='PRCP',
#'    startdate = '2010-05-01', enddate = '2010-05-10')
#'
#' # Normals Daily GHCND dly-tmax-normal data
#' ncdc2(datasetid='NORMAL_DLY', datatypeid='dly-tmax-normal',
#'    startdate = '2010-05-01', enddate = '2010-05-10')
#'
...
#' ncdc2(datasetid='PRECIP_15', datatypeid='QPCP',
#'    startdate = '2010-05-01', enddate = '2010-05-02')
#'
#' # Search the NORMAL_HLY dataset
#' ncdc2(datasetid='NORMAL_HLY', stationid = 'GHCND:USW00003812',
#'    startdate = '2010-05-01', enddate = '2010-05-10')
#'
#' # Search the GSOY dataset
#' ncdc2(datasetid='ANNUAL', locationid='ZIP:28801', startdate = '2010-05-01',
#'    enddate = '2010-05-10')
#'
#' # Search the NORMAL_ANN dataset
#' ncdc2(datasetid='NORMAL_ANN', datatypeid='ANN-DUTR-NORMAL',
...
#' ## get some data
#' ncdc2(datasetid = "GSOY", stationid = stat$data$id[1:10],
...
#' # NEXRAD2 data
#' ## doesn't work yet
#' ncdc2(datasetid='NEXRAD2', startdate = '2013-10-01', enddate = '2013-12-01')
#'
#' ncdc2(datasetid='daily-summaries', datatypeid = 'PRCP', stationid = 'USW00003812', startdate = '2013-10-01', enddate = '2013-12-01')
#'
#' ncdc2(datasetid='GHCND', datatypeid=c('PRCP'), stationid="GHCND:US1LAWC0001",
                 ...
                 token=NULL, includemetadata=TRUE, add_units=FALSE, units='metric', ...)
{
  ...
  args <- noaa_compact(list(dataset  = datasetid,
                            stations = stationid,
  ...
  if (length(args) == 0) args <- NULL
    ...
    tt <- ncdc_GET("", args = args, token = token)

    dat <- readr::read_csv(tt$url) |>
...
ncdc_GET <- function(path, args = NULL, token = NULL, ...) {
  cli <- crul::HttpClient$new(
    url = paste0(ncdc_base2(), path),
...
split_atts <- function(x, ds = "GSOM"){
  out <- switch(
    ds,
    GHCND = parse_ncdc2(x, c('fl_m','fl_q','fl_so','fl_t')),
    # leave in duplicate for now
    GHCNDMS = parse_ncdc2(x, c('fl_miss','fl_cmiss')),
    GSOM = parse_ncdc2(x, fun = gsom_mapper),
    # leave in duplicate for now
    ANNUAL = parse_ncdc2(x, c('fl_m','fl_q','fl_d','fl_u')),
    GSOY = parse_ncdc2(x, fun = gsoy_mapper),
    # no data returned, fix when data returned
    NEXRAD2 = parse_ncdc2(x, c('x','x')),
    # no data returned, fix when data returned
    NEXRAD3 = parse_ncdc2(x, c('x','x')),
    NORMAL_ANN = parse_ncdc2(x, 'fl_c'),
    NORMAL_DLY = parse_ncdc2(x, 'fl_c'),
    NORMAL_HLY = parse_ncdc2(x, 'fl_c'),
    NORMAL_MLY = parse_ncdc2(x, 'fl_c'),
    PRECIP_15 = parse_ncdc2(x, c('fl_m','fl_q','fl_u')),
    PRECIP_HLY = parse_ncdc2(x, c('fl_m','fl_q'))
  )
...
ncdc_base2 <- function() 'https://www.ncei.noaa.gov/access/services/data/v1/'

# ncdc_base2 <- function() 'https://www.ncei.noaa.gov/access/services/search/v1/'
