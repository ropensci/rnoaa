...
ncdc_units_gsoy <- list(
  ...
  "FZF0" = list(name = "FZF0", units = "", description = "First freeze <= to 32F/0C of the year."),
  "FZF1" = list(name = "FZF1", units = "", description = "First freeze <= 28F/-2.2C of the year"),
  "FZF2" = list(name = "FZF2", units = "", description = "First freeze <= 24F/-4.4C of the year"),
  "FZF3" = list(name = "FZF3", units = "", description = "First freeze <= 20F/-6.7C of the year"),
  "FZF4" = list(name = "FZF4", units = "", description = "First freeze <= 16F/-8.9C of the year"),
  "FZF5" = list(name = "FZF5", units = "", description = "Last freeze <= 32F/0C of the year"),
  "FZF6" = list(name = "FZF6", units = "", description = "Last freeze <= 28F/-2.2C of the year"),
  "FZF7" = list(name = "FZF7", units = "", description = "Last freeze <= 24F/-4.4C of the year"),
  "FZF8" = list(name = "FZF8", units = "", description = "Last freeze <= 20F/-6.7C of the year"),
  "FZF9" = list(name = "FZF9", units = "", description = "Last freeze <= 16F/-8.9C of the year"),
