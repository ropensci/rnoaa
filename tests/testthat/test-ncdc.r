...
Sys.sleep(time = 0.5)
aa <- ncdc(datasetid='NORMAL_DLY', datatypeid='dly-tmax-normal', startdate = '2010-05-01', enddate = '2010-05-10', token=key)
...
Sys.sleep(time = 0.5)
gg <- ncdc(datasetid='GHCND', datatypeid = 'PRCP', stationid='GHCND:USC00200230', startdate = "2013-09-03", enddate = "2013-09-30", limit=30, token=key)
...
test_that("ncdc returns the correct class", {
...
test_that("ncdc returns the correct dimensions", {
