...
test_that("search for data", {
  ...
  expect_less_than(NROW(search_b$prcp), NROW(search_a$prcp))
})
...
test_that("get data", {
  ...
  expect_less_than(NROW(cc$data), NROW(aa$data))
  expect_less_than(NROW(aa$data), NROW(bb$data))
  expect_less_than(NROW(cc$data), NROW(bb$data))
})
