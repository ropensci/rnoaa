...
# Tentative leads:
CRAN has an R package called "gimms", that purports to be able to read in GIMMS NDVI3g data. It seems the package was explicitly designed to work with data available at "http://ecocast.arc.nasa.gov/data/pub/gimms/3g.v0/." 
