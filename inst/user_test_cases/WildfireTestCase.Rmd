...
author: Brooke Anderson (BA), Sheryl Magzamen (SM), Ryan Gan (RG), Miranda Fix (MF)
  Steven J. Brey (SJB), Joshua Ferreri (JF), Molly Gutilla (MG)
...
MG: This work is use the RNCEP package to obtain global weather and climate data.
...
wx.ag # aggregated time components have been replace with XX or XXXX
dimnames(wx.ag[[3]][1])
wx.ag
