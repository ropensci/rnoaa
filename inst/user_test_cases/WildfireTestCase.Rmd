...
system.time(gimms_files_date <- downloadGimms(x = as.Date("2013-01-01"), y = as.Date("2013-06-30"), dsn = gimms_dir))
...
system.time(gimms_raster_mvc <- monthlyComposite(gimms_raster, indices = indices)) # 16 seconds

# Now, let's visualize the data
library(sp) # package for spatial data
names(gimms_raster_mvc) <- paste(month.abb, 2000)
# returns the error "incorrect number of layer names"
spplot(gimms_raster_mvc) # This still works. 
