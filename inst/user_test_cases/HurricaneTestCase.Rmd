...
author: "Brooke Anderson (BA), Rachel Severson (RS), Casey Patrizio (CP)"
...
ggplot(miami_wind, aes(x = date, y = wsfg)) + 
  ...
  ylab("Wind gust (m / s)") 
```
CP: We want to see if we can get data from some other of the test cases. 
...
```{r}
res <- isd(usaf = "722020", wban = "12839", year = 1992)$data
