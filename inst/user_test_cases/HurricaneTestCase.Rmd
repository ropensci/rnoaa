...
EW: This a function to plot the storm path. You need to know the `name`, `year`, and `location` of the storm you would like to analyze. The function provides two types of map: the whole map or the local map.
