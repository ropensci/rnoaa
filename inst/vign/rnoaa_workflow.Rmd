...
This vignette is intended to demonstrate a workflow for using the NOAA NCDC data. It can be confusing to understand how to get at data you want - that's why this vignette is needed. Other vignettes show more thorough and different examples.
